...
def draw(screen, x, y):
    ...
    pygame.draw.rect(screen, (0, 0, 200), (x+300, y + 50, 100, 50))
    ...
    pygame.draw.polygon(screen, (200, 0, 0), [(x + 300, y + 50), (x + 300, y + 0), (x + 400, y + 50)])
    pygame.draw.polygon(screen, (200, 0, 0), [(x + 300, y + 100), (x + 300, y + 0), (x + 400, y + 50)])
    ...
    pygame.draw.circle(screen, (0, 200, 200), (x + 350, y + 20), 20)
    ...
    pygame.draw.ellipse(screen, (200, 200, 0), (x + 350, y + 100, 30, 70))
    ...
    pygame.draw.line(screen, (0, 0, 0), (x + 0, y + 0), (x + 1000, y + 100))
