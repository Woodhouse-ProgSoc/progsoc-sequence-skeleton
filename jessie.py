...
def draw(screen, x, y):
    ...
    pygame.draw.rect(screen, (0, 0, 0), (x, y + 50, 20, 100))
    ...
    pygame.draw.rect(screen, (0, 0, 0), (x + 50, y + 50, 20, 100))

    pygame.draw.rect(screen, (0, 0, 0), (x, y + 75, 50, 20))

    pygame.draw.rect(screen, (0, 0, 0), (x + 100, y + 50, 20, 100))

    #pygame.draw.polygon(screen, (0, 0, 0), [(x + 0, y + 50), (x + 50, y + 0), (x + 100, y + 50)])
    ...
    #pygame.draw.circle(screen, (0, 0, 0), (x + 25, y + 25), 20)
    ...
    #pygame.draw.ellipse(screen, (0, 0, 0), (x + 25, y + 25, 30, 70))
