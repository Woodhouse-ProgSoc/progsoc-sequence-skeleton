...
def draw(screen, x, y):
    ...
    pygame.draw.circle(screen, (150,255,255), (x + 90, y + 10), 20)
    pygame.draw.circle(screen, 0, (x + 80, y + 10), 10)

    pygame.draw.circle(screen, (150, 255, 255), (x + 210, y + 10), 20)
    pygame.draw.circle(screen, 0, (x + 200, y + 10), 10)
